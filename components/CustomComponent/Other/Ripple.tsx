...
export default function Ripple({
    ...
    return (
        <div className="relative w-full h-screen flex items-center justify-center overflow-hidden">
            <div className="relative" style={{ width: mainCircleSize * 3, height: mainCircleSize * 3 }}>
                {/* Ripple circles */}
                ...
                {/* Center content */}
                <div className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 text-center ${centerClassName}`}>
                    {centerContent || (
                        <h1>
                            {children}
                        </h1>
