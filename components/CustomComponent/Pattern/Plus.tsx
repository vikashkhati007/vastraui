...
const ChessPatternBackground: React.FC<PatternBackgroundProps> = ({ children }) => {
  return (
    <div className="pattern-background">
      ...
      <style jsx>{`
        .pattern-background {
          background:
            radial-gradient(circle, transparent 20%, black 20%, black 80%, transparent 80%, transparent),
