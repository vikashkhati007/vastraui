          ...
          <code
            dangerouslySetInnerHTML={{
              __html: Prism.highlight(
                code,
                Prism.languages[language] || Prism.languages.jsx,
                language
              ),
            }}
  ...
  <div className="w-full max-w-3xl mx-auto">
    <div className="overflow-x-auto shadow-md ">
      <table className="w-full text-left border-collapse">
        <thead>
          <tr>
            <th className="py-2 sm:py-4 px-4 sm:px-6 text-sm sm:text-base font-semibold text-gray-300">
              Prop
            </th>
            <th className="py-2 sm:py-4 px-4 sm:px-6 text-sm sm:text-base font-semibold text-gray-300">
              Type
        ...
        <tbody>
          {props.map((prop) => (
            <tr key={prop.name} className="border border-divider">
              <td className="py-2 sm:py-4 px-4 sm:px-6 text-sm sm:text-base font-mono text-gray-300">
                {prop.name}
              </td>
              <td className="py-2 sm:py-4 px-4 sm:px-6 text-sm sm:text-base font-mono text-blue-400">
                {prop.type}
              </td>
              <td className="py-2 sm:py-4 px-4 sm:px-6 text-sm sm:text-base text-gray-300">
                {prop.description}
              </td>
              <td className="py-2 sm:py-4 px-4 sm:px-6 text-sm sm:text-base font-mono text-gray-300">
                {prop.default}
  ...
  return (
    <div className="w-full min-h-[600px] p-4">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <Tab key="preview" title={<span>Preview</span>}>
          ...
          <Tab key="code" title={<span>Code</span>}>
            <CodeBlock
              code={codestring}
              copied={copied}
              language="jsx"
