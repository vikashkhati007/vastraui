      ...
      >
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4 text-lg text-gray-600 dark:text-gray-300">
            <p>
              Vastra UI is more than just a collection of components - it's a
              carefully crafted ecosystem of reusable elements designed to
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-6 text-lg text-gray-600 dark:text-gray-300">
            ...
            <p>
              In today's digital landscape, trust is the currency that drives
              conversions. It's the first thing visitors evaluate before making
              any commitment, whether that's sharing their email or making a
              purchase.
            </p>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold">Installing Component Command</h3>
              <div className="w-full">
                <div className="relative">
                  <pre className="bg-[#2d2d2d] rounded-lg p-4 overflow-x-auto">
                    <div className="absolute right-2 top-2 flex gap-2">
                      <Button
                        ...
                        variant="light"
                        onPress={() =>
                          copyToClipboard(`vastraui add @vastra/glowing`, "component")
                        }
                        className="text-gray-400 hover:text-gray-300"
                        aria-label="Copy code"
                      >
                        {copied["component"] ? <Check size={18} /> : <Copy size={18} />}
                      </Button>
                    </div>
                    <code
                      className={`language-${"jsx"} text-sm`}
